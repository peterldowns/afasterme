	...
	"renderCalendar" : function(mm,yy){
      ...
      _html += '<td class="summary"></td>';
		...
		$('#last').unbind('click').bind('click',function(){
			Calendar.renderCalendar(prv.getMonth(),prv.getFullYear());
		});
		
		$('#current').unbind('click').bind('click',function(){
			Calendar.renderCalendar(now.getMonth(),now.getFullYear());
		});
		
		$('#next').unbind('click').bind('click',function(){
			Calendar.renderCalendar(nxt.getMonth(),nxt.getFullYear());
		});
